...
-- -----------------------------------------------------
-- Table `logkennel`.`settings_text`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `logkennel`.`settings_text` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `settings_id` INT(11) UNSIGNED NOT NULL,
  `settings_text` TEXT NOT NULL,
  `lang_id` TINYINT(1) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_settings_text_settings1_idx` (`settings_id` ASC),
  INDEX `fk_settings_text_lang1_idx` (`lang_id` ASC),
  CONSTRAINT `fk_settings_text_settings1`
    FOREIGN KEY (`settings_id`)
    REFERENCES `logkennel`.`settings` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_settings_text_lang1`
    FOREIGN KEY (`lang_id`)
    REFERENCES `logkennel`.`lang` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
